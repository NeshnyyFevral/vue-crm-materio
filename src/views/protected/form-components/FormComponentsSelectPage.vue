<template>
  <VPreviewComponentPage>
    ...
    >
      <VSelect
        v-model="variantSelectValue"
        :variant="variantSelectValue as TextFieldVariant"
        label="Variant"
      ...
      <VSelect
        ...
        :color="colorSelectValue as GlobalColors"
        label="Color"
...
const colorOptions = ref<SelectOptions<string>[]>([
